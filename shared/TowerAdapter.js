...
(function () {
  ...
  // Tower Exchange integrates Arc. Quote only on Arc Mainnet (5042). Any other
  // chain must NOT quote (no stale Testnet leakage, no unsupported chain calls).
  // Defaults to Arc when no active chain is set.
