...
(function(){
  ...
  function _taskToSchedule(task) {
    ...
    var schedule = {
      ...
      total: task.amount || 0,
      network: task.chain || 'Arc_Mainnet',
      fromNetwork: task.fromChain || 'Arc_Mainnet',
      toNetwork: task.chain || 'Arc_Mainnet',
  ...
  function _scheduleToTaskView(schedule) {
    ...
    return {
      ...
      chain: schedule.network || 'Arc Mainnet',
  ...
  function scheduleNow(opts) {
    ...
    var schedule = {
      ...
      total: opts.amount || 0,
      network: opts.network || 'Arc_Mainnet',
      fromNetwork: opts.fromNetwork || 'Arc_Mainnet',
      toNetwork: opts.toNetwork || 'Arc_Mainnet',
