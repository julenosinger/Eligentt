 ...
 *   4. chain (Arc Mainnet for on-chain ops; trusted CCTP source set for bridge)
...
(function () {
  ...
  var CCTP_SOURCE_CHAINS = [5042, 1, 8453, 42161, 10, 137];
  ...
  async function authorizeAutonomaExecution(intent, context) {
    ...
    var network = intent.network || 'Arc Mainnet';
