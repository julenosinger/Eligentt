...
const ElligenteChains = Object.freeze({
  ...
  CHAIN_REGISTRY: {
    ...
    4663:     { id:'Robinhood_Mainnet',name:'Robinhood Chain',shortName:'Robinhood',chainId:4663,    chainHex:'0x1237',   rpc:'https://rpc.mainnet.chain.robinhood.com',     explorer:'https://robinhoodchain.blockscout.com',    domain:null, nativeCurrency:{name:'ETH',symbol:'ETH',decimals:18} },
    46630:    { id:'Robinhood_Testnet',name:'Robinhood Chain Testnet',shortName:'Robinhood Test',chainId:46630,chainHex:'0xb626',rpc:'https://rpc.testnet.chain.robinhood.com',    explorer:'https://explorer.testnet.chain.robinhood.com',domain:null,nativeCurrency:{name:'ETH',symbol:'ETH',decimals:18} }
  },

  CHAINS_ORDER: ['Arc_Testnet','Ethereum_Sepolia','Base_Sepolia','Arbitrum_Sepolia','Optimism_Sepolia','Polygon_Amoy','Robinhood_Testnet'],
